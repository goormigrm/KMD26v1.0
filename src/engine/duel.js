...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=38e22109f1";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=38e22109f1";
import { seedRNG, deriveSeed } from "./rng.js?v=38e22109f1";
import { installDuelRules } from "./rules.js?v=38e22109f1";
import { installOrders } from "./orders.js?v=38e22109f1";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero, takeCaps } from "./replay.js?v=38e22109f1";
