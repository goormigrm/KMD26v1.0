...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=271bde54ea";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=271bde54ea";
import { seedRNG, deriveSeed } from "./rng.js?v=271bde54ea";
import { installDuelRules } from "./rules.js?v=271bde54ea";
import { installOrders } from "./orders.js?v=271bde54ea";
import { installReplay, takeClips, rosterOf, frameZero } from "./replay.js?v=271bde54ea";
