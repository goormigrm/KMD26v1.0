...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=8becaaf894";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=8becaaf894";
import { seedRNG, deriveSeed } from "./rng.js?v=8becaaf894";
import { installDuelRules } from "./rules.js?v=8becaaf894";
import { installOrders } from "./orders.js?v=8becaaf894";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero } from "./replay.js?v=8becaaf894";
