...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=074bd45315";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=074bd45315";
import { seedRNG, deriveSeed } from "./rng.js?v=074bd45315";
import { installDuelRules } from "./rules.js?v=074bd45315";
import { installOrders } from "./orders.js?v=074bd45315";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero } from "./replay.js?v=074bd45315";
