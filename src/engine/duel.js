...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=cef98bc935";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=cef98bc935";
import { seedRNG, deriveSeed } from "./rng.js?v=cef98bc935";
import { installDuelRules } from "./rules.js?v=cef98bc935";
import { installOrders } from "./orders.js?v=cef98bc935";
import { installReplay, takeClips, rosterOf, frameZero } from "./replay.js?v=cef98bc935";
