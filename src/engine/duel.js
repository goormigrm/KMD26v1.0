...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=58501eeef2";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=58501eeef2";
import { seedRNG, deriveSeed } from "./rng.js?v=58501eeef2";
import { installDuelRules } from "./rules.js?v=58501eeef2";
import { installOrders } from "./orders.js?v=58501eeef2";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero } from "./replay.js?v=58501eeef2";
