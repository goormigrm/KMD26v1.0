...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=3ee4653b96";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=3ee4653b96";
import { seedRNG, deriveSeed } from "./rng.js?v=3ee4653b96";
import { installDuelRules } from "./rules.js?v=3ee4653b96";
import { installOrders } from "./orders.js?v=3ee4653b96";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero } from "./replay.js?v=3ee4653b96";
