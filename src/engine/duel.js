...
import { MatchSim, SIM_SECONDS, MATCH_CLOCK_SCALE, onPitch } from "./kernel.js?v=5659e8d397";
import { installEngineContext, normalizeTeam } from "./stubs.js?v=5659e8d397";
import { seedRNG, deriveSeed } from "./rng.js?v=5659e8d397";
import { installDuelRules } from "./rules.js?v=5659e8d397";
import { installOrders } from "./orders.js?v=5659e8d397";
import { installReplay, takeClips, takeWatch, rosterOf, frameZero } from "./replay.js?v=5659e8d397";
