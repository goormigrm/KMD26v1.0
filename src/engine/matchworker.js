...
import { runHeadless, deriveSeed } from "./duel.js?v=58501eeef2";
import { checkLineup, prepareSides, aiLineup, AI_PRESETS, counterPreset } from "./teams.js?v=58501eeef2";
import { encodePlan } from "../codec/duelcode.js?v=58501eeef2";
import { makeReactions } from "./reactions.js?v=58501eeef2";
import { slotRating } from "./kernel.js?v=58501eeef2";
import { installEngineContext } from "./stubs.js?v=58501eeef2";
