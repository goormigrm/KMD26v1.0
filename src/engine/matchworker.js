...
import { runHeadless, deriveSeed } from "./duel.js?v=d3d835944f";
import { checkLineup, prepareSides, aiLineup, AI_PRESETS, counterPreset } from "./teams.js?v=d3d835944f";
import { encodePlan } from "../codec/duelcode.js?v=d3d835944f";
import { makeReactions } from "./reactions.js?v=d3d835944f";
import { slotRating } from "./kernel.js?v=d3d835944f";
import { installEngineContext } from "./stubs.js?v=d3d835944f";
