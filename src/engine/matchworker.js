...
import { runHeadless, deriveSeed } from "./duel.js?v=1e69f53a50";
import { checkLineup, prepareSides, aiLineup, AI_PRESETS, counterPreset } from "./teams.js?v=1e69f53a50";
import { encodePlan } from "../codec/duelcode.js?v=1e69f53a50";
import { makeReactions } from "./reactions.js?v=1e69f53a50";
import { slotRating } from "./kernel.js?v=1e69f53a50";
import { installEngineContext } from "./stubs.js?v=1e69f53a50";
