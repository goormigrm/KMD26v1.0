...
(2026-08-18 기준 58곳) — 페이지·모듈이 늘면 같이 늘어나므로 이 숫자를 외우지 마세요.
...
파일은 열 개인데 **두 갈래**로 나뉩니다. 고칠 때 어느 쪽인지 먼저 보세요.

> ⚠ **왼쪽 바에는 다섯 개만 있습니다**(첫 페이지 + KM26 넷).
> 2026 갈래 다섯 화면은 2026-08-17 에 **바에서만 감췄습니다** — 파일은 그대로 있고
> 주소를 직접 치면 열립니다. `DEVELOPMENT.md` 의 "2026 갈래는 화면에서만 감췄습니다" 참고.
