...
### 소스를 고쳤으면 **네 곳을 함께** 고친다

문서를 나중에 몰아서 쓰면 반드시 어긋납니다. 코드와 **같은 커밋**에 넣으세요.

| 순서 | 파일 | 무엇을 | 누가 읽나 |
|---|---|---|---|
| 1 | **[CHANGELOG.md](CHANGELOG.md)** | 무엇이 바뀌었나 (정본) | 사용자 · 다음 세션 |
| 2 | **[README.md](README.md)** | 어떻게 하는 게임인가 — **대전 방식·플레이 방법** | 처음 오는 사람 |
| 3 | **[docs/공지글-모음.md](docs/공지글-모음.md)** | 게시판에 붙여 넣을 공지 (한 줄에 한 항목) | 게시판 독자 |
| 4 | **[DEVELOPMENT.md](DEVELOPMENT.md)** | **왜** 그렇게 만들었나 · 측정치 · 함정 | 고치는 사람 |
